...
본 프로젝트는 Windows 환경에서 동작하는 고성능 3D 게임 엔진을 개발하는 것을 목적으로 합니다. 엔진의 모든 설계는 SOLID 원칙을 기반으로 하여 모듈 간의 의존성을 최소화하고 확장성을 극대화하는 방향으로 진행됩니다. 단순히 기능을 나열하는 것에 그치지 않고, 현대적인 엔진 아키텍처의 당위성을 코드로 증명하는 데 초점을 맞추고 있습니다.
...
### 본 프로젝트는 Visual Studio 2022 환경에서 C++20 표준을 사용하여 개발되었습니다.
    ...
    Win-GenProjects.bat을 실행하여 Visual Studio 솔루션 파일을 생성하고 프로젝트를 빌드합니다.